...
public class UploadGestures extends AppCompatActivity implements View.OnClickListener {
    public static Map<String, Integer> counterMap = new HashMap<>();

    private static int VIDEO_REQUEST=201;
    String ipv4AddressServer="192.168.0.8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_upload_gesture);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(UploadGestures.this, "Connection to server not established", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(UploadGestures.this, "Video uploaded to server", Toast.LENGTH_SHORT).show();
                        Intent backToSquareOne = new Intent(UploadGestures.this, MainActivity.class);
                        finish();
            ...
            postBodyImage = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("image",
                            gestureSelected+"_PRACTICE_"+counterMap.get(gestureSelected)+
                                    "_nallamjompalli"+".mp4", RequestBody.create(MediaType.parse("video/*"), stream))
                    .build();
